  ...
  render() {
    ...
    return (
      <Div flex={1} column itemsCenter padding="0 16px 30px">
            ...
            <Switch>
              <Route path="/onboarding-2/usp/1">
                <Div flex={1} column itemsCenter padding={30}>
                  ...
                  <Button onClick={() => this.props.history.push('/onboarding-2/usp/2')}>{t[8]}</Button>
                </Div>
              </Route>
              ...
              <Route path="/onboarding-2/usp/2">
                <Div flex={1} column itemsCenter padding={30}>
                  ...
                  <Button onClick={() => this.props.history.push('/onboarding-2/usp/3')}>{t[8]}</Button>
                </Div>
              </Route>
              ...
              <Route path="/onboarding-2/usp/3">
                <Div flex={1} column itemsCenter padding={30}>
                  ...
                  <Button onClick={() => this.props.history.push('/onboarding-2/usp/4')}>{t[8]}</Button>
                </Div>
              </Route>
              ...
              <Route path="/onboarding-2/usp/4">
                <Div flex={1} column itemsCenter padding={30}>
                  ...
                  <Button onClick={() => this.props.history.push('/onboarding-2/step-1')}>{t[8]}</Button>
                </Div>
              </Route>
            </Switch>
          </Div>
        ...
        <Pagination size={4} value={currentSlide} onChange={this.goToSlide} />
      </Div>
    )
  }
}
