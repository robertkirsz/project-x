...
const paths = routes.filter(route => route.includes('/onboarding-2/step-2/'))
...
class Step1Page extends Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <StepInfo step={2} path={this.props.location.pathname} paths={paths}>personal information</StepInfo>
