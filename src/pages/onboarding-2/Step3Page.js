  ...
  render() {
    ...
    const name = (
      <Div flex={1} column padding="30px 16px">
        ...
        <Button
          onClick={() => this.props.history.push('/onboarding-2/step-3/card')}
    ...
    const card = (
      <Div flex={1} column itemsCenter padding="30px 16px">
        ...
        <Button onClick={() => this.props.history.push('/onboarding-2/step-3/contact')} style={{ marginTop: 'auto' }}>
          {texts.misc.nextStep}
        </Button>
      </Div>
    )
    ...
    const contact = (
      <Div flex={1} column padding="30px 16px">
        ...
        <Button
          onClick={() => this.props.history.push('/onboarding-2/step-4/name')}
